package com.english_hub.core.features.auth.application.service;
...
import com.english_hub.core.features.auth.domain.model.RefreshToken;
import com.english_hub.core.features.auth.domain.repository.AuthUserRepository;
import com.english_hub.core.features.auth.domain.repository.RefreshTokenRepository;
import com.english_hub.core.features.auth.domain.service.TokenHasher;
...
class AuthServiceTest {
	...
	void loginSucceedsAndPersistsTheHashedRefreshToken() {
		...
		when(jwtTokenService.createAccessToken(eq(USER_ID), any(
				com.english_hub.core.features.user.domain.model.UserRole.class))).thenReturn("access-token");
		...
		ArgumentCaptor<com.english_hub.core.features.user.domain.model.UserRole> roleCaptor =
				ArgumentCaptor.forClass(com.english_hub.core.features.user.domain.model.UserRole.class);
		verify(jwtTokenService).createAccessToken(eq(USER_ID), roleCaptor.capture());
		assertThat(roleCaptor.getValue()).isEqualTo(com.english_hub.core.features.user.domain.model.UserRole.TEACHER);
	...
	void refreshSucceedsAndMintsANewAccessToken() {
		...
		when(jwtTokenService.createAccessToken(eq(USER_ID), any(
				com.english_hub.core.features.user.domain.model.UserRole.class))).thenReturn("new-access-token");
