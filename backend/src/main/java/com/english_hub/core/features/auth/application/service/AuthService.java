...
public class AuthService {
	...
	private com.english_hub.core.features.user.domain.model.UserRole toUserFeatureRole(
			com.english_hub.core.common.domain.UserRole role) {
		return com.english_hub.core.features.user.domain.model.UserRole.valueOf(role.name());
	}
