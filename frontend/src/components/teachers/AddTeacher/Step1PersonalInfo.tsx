    ...
    <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div className="card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ width: '160px', height: '160px', backgroundColor: '#E0E7FF', borderRadius: '16px', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', marginBottom: '16px' }}>
             <span style={{ fontSize: '48px', fontWeight: 'bold', color: '#1D4ED8' }}>GV</span>
      ...
      <div className="card" style={{ padding: '32px' }}>
         ...
         <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
            <div>
               <label className="label-md" style={{ display: 'block', marginBottom: '8px' }}>Họ và tên giảng viên <span style={{color: '#DC2626'}}>*</span></label>
               <input type="text" className="input" defaultValue="Nguyễn Thị Kim Oanh" />
            </div>
            <div>
               <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <label className="label-md">Mã định danh <span style={{color: '#DC2626'}}>*</span></label>
                  <span className="badge" style={{ backgroundColor: '#D1FAE5', color: '#059669', padding: '2px 8px', fontSize: '11px' }}>HỢP LỆ</span>
               </div>
               <div style={{ display: 'flex', position: 'relative' }}>
                  <input type="text" className="input" defaultValue="GV-2026-089" style={{ backgroundColor: '#EEF2FF', fontWeight: '500', color: '#1D4ED8' }} />
         ...
         <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px', marginBottom: '24px' }}>
            <div>
               <label className="label-md" style={{ display: 'block', marginBottom: '8px' }}>Số điện thoại liên hệ <span style={{color: '#DC2626'}}>*</span></label>
               <div style={{ position: 'relative' }}>
                  ...
                  <input type="text" className="input" defaultValue="0912 345 678" style={{ paddingLeft: '36px' }} />
               </div>
            </div>
            <div>
               <label className="label-md" style={{ display: 'block', marginBottom: '8px' }}>Ngày sinh</label>
               <input type="date" className="input" defaultValue="1989-08-16" />
            </div>
            <div>
         ...
         <div style={{ marginBottom: '24px' }}>
            <label className="label-md" style={{ display: 'block', marginBottom: '8px' }}>Địa chỉ liên hệ / Tạm trú</label>
            <div style={{ position: 'relative' }}>
               ...
               <input type="text" className="input" defaultValue="Số 18 Hoàng Quốc Việt, Phường Nghĩa Đô, Quận Cầu Giấy, Hà Nội" style={{ paddingLeft: '36px' }} />
            </div>
         </div>

         <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
               <label className="label-md">Giới thiệu ngắn gọn / Tiểu sử</label>
               <span className="label-md text-on-surface-variant" style={{ fontSize: '12px' }}>Tối đa 500 ký tự</span>
            </div>
            <textarea className="input" style={{ height: '100px', paddingTop: '12px', resize: 'vertical' }} defaultValue="Tiến sĩ Sư phạm Toán ứng dụng với hơn 8 năm kinh nghiệm giảng dạy tại các viện công nghệ. Đạt giải Nhà giáo Tiêu biểu cấp Ngành năm 2024."></textarea>
         </div>
      </div>
    </div>
  );
