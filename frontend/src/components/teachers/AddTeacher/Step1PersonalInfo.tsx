    ...
    <div className="grid grid-300-1fr gap-24">
      ...
      <div className="card p-32">
         ...
         <div className="grid grid-2 gap-24 mb-24">
            <div>
               <label className="label-md mb-8" style={{ display: 'block' }}>Họ và tên giảng viên <span className="text-error">*</span></label>
            ...
            <div>
               <div className="flex-between mb-8">
                  ...
                  <span className="badge badge-status-active font-medium" style={{ padding: '2px 8px', fontSize: '11px' }}>HỢP LỆ</span>
               </div>
               <div className="flex relative">
                  <input type="text" className="input text-primary font-medium" defaultValue="GV-2026-089" style={{ backgroundColor: '#EEF2FF' }} />
         ...
         <div className="grid grid-3 gap-24 mb-24">
            <div>
               <label className="label-md mb-8" style={{ display: 'block' }}>Số điện thoại liên hệ <span className="text-error">*</span></label>
         ...
         <div className="mb-24">
            <label className="label-md mb-8" style={{ display: 'block' }}>Địa chỉ liên hệ / Tạm trú</label>
            <div className="relative">
