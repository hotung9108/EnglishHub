  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div className="card" style={{ padding: '24px', backgroundColor: '#EFF6FF', borderColor: '#DBEAFE', display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
        ...
        <div>
           <h4 className="headline-md" style={{ color: '#1E3A8A', fontSize: '18px', marginBottom: '4px' }}>Phân công lớp học</h4>
           <p className="label-md" style={{ color: '#3B82F6', fontWeight: '400' }}>Xếp lịch giảng dạy và gán giáo viên vào các lớp học hiện có.</p>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: '32px' }}>
         ...
         <div style={{ marginBottom: '24px' }}>
            <label className="label-md" style={{ display: 'block', marginBottom: '8px' }}>Lớp học đảm nhiệm</label>
            ...
            <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
               <div style={{ border: '1px solid var(--outline-variant)', borderRadius: 'var(--radius-sm)', padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button className="btn btn-secondary" style={{ padding: '6px 12px', fontSize: '13px' }}>Gán lớp</button>
               </div>
               <div style={{ border: '1px solid var(--outline-variant)', borderRadius: 'var(--radius-sm)', padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
