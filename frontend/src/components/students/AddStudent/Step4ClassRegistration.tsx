  ...
  return (
    <div className="flex-col gap-24">
      <div className="step-header">
        ...
        <div>
           <h4 className="headline-md step-header-title">Đăng ký lớp học</h4>
           <p className="label-md step-header-desc">Sắp xếp lịch học và gán học viên vào các lớp học hiện có.</p>
        </div>
      </div>
      ...
      <div className="card p-32">
         ...
         <div className="mb-24">
            <label className="label-md mb-8" style={{ display: 'block' }}>Lớp học đăng ký</label>
            ...
            <div className="flex-col gap-12 mt-16">
               <div className="flex-between border rounded p-12-16">
                  ...
                  <button className="btn btn-secondary py-6 px-12" style={{ fontSize: '13px' }}>Gán vào lớp</button>
               </div>
               <div className="flex-between border rounded p-12-16">
                  <div>
