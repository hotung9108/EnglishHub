      ...
      <div className="card" style={{ padding: '24px', marginBottom: '24px' }}>
         <div style={{ display: 'flex', justifyContent: 'space-between', position: 'relative' }}>
            ...
            {[
               ...
               { id: 3, label: 'Trình độ & Mục tiêu', status: currentStep > 3 ? 'completed' : currentStep === 3 ? 'current' : 'pending' },
               { id: 4, label: 'Đăng ký lớp học', status: currentStep > 4 ? 'completed' : currentStep === 4 ? 'current' : 'pending' },
            ].map(step => (
      ...
      <div className="card" style={{ padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
         ...
         <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <button className="btn btn-primary" onClick={handleNext}>
               {currentStep < 4 ? `Tiếp theo: ${currentStep === 1 ? 'Tài khoản & Đăng nhập' : currentStep === 2 ? 'Trình độ & Mục tiêu' : 'Đăng ký lớp học'}` : 'Hoàn thành'}
