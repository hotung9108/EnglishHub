      ...
      <div className="card p-24 mb-24">
         <div className="stepper">
            ...
            {[
               ...
               { id: 3, label: t('addTeacher.step3'), status: currentStep > 3 ? 'completed' : currentStep === 3 ? 'current' : 'pending' },
               { id: 4, label: t('addTeacher.step4'), status: currentStep > 4 ? 'completed' : currentStep === 4 ? 'current' : 'pending' },
            ].map(step => (
      ...
      <div className="card p-24 flex-between">
         ...
         <div className="flex gap-16">
            ...
            <button className="btn btn-primary" onClick={handleNext}>
               {currentStep < 4 ? (currentStep === 1 ? t('addStudent.btnNextStep2') : currentStep === 2 ? t('addTeacher.btnNextStep3') : t('addTeacher.btnNextStep4')) : t('addStudent.btnFinish')}
